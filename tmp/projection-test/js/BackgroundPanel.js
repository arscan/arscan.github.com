...
function createBackgroundPanel(renderer, width, height){
    ...
    function init(){
        ...
        uniforms[ "tNormal" ].value = THREE.ImageUtils.loadTexture( "../projection-test/images/background_normal.png", undefined, LOADSYNC.register() );
        uniforms[ "uNormalScale" ].value.set( 0.8, 0.8 );

        uniforms[ "tDiffuse" ].value = THREE.ImageUtils.loadTexture( "../projection-test/images/background_diffuse.png", undefined, LOADSYNC.register() );
        ...
        var number1 = new THREE.Mesh(new THREE.PlaneBufferGeometry(35, 35), 
                                     new THREE.MeshBasicMaterial({transparent: true, opacity: .7, map: THREE.ImageUtils.loadTexture("../projection-test/images/number1.png", undefined, LOADSYNC.register())}));
        number1.position.set(-510, 340, -460);
        scene.add(number1);

        var number2 = new THREE.Mesh(new THREE.PlaneBufferGeometry(35, 35), 
                                     new THREE.MeshBasicMaterial({transparent: true, opacity: .7, map: THREE.ImageUtils.loadTexture("../projection-test/images/number2.png", undefined, LOADSYNC.register())}));
        number2.position.set(-510, 145, -460);
        scene.add(number2);

        var number3 = new THREE.Mesh(new THREE.PlaneBufferGeometry(35, 35), 
                                     new THREE.MeshBasicMaterial({transparent: true, opacity: .7, map: THREE.ImageUtils.loadTexture("../projection-test/images/number3.png", undefined, LOADSYNC.register())}));
        number3.position.set(-510, -45, -460);
        scene.add(number3);

        var number4 = new THREE.Mesh(new THREE.PlaneBufferGeometry(35, 35), 
                                     new THREE.MeshBasicMaterial({transparent: true, opacity: .7, map: THREE.ImageUtils.loadTexture("../projection-test/images/number4.png", undefined, LOADSYNC.register())}));
        number4.position.set(-510, -243, -460);
        scene.add(number4);
        
        var horizTexture = new THREE.MeshBasicMaterial({transparent: true, opacity: .8, map: THREE.ImageUtils.loadTexture("../projection-test/images/horizontal_lights.png", undefined, LOADSYNC.register())});
