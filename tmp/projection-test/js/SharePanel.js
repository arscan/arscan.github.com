function createSharePanel(renderer, scale){
   ...
   function createGithubCanvas(){
    ...
    function init(){
        ...
        var twitterIconTexture = THREE.ImageUtils.loadTexture('/tmp/projection-test/images/twitter.png', undefined, LOADSYNC.register() );
        ...
        var githubIconTexture = THREE.ImageUtils.loadTexture('/tmp/projection-test/images/github.png', undefined, LOADSYNC.register() );
